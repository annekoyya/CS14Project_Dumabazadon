        ...
        >
            <ul className="space-y-2 font-medium flex flex-col justify-between h-full">
                <div className='flex flex-col gap-3'>
                            ...
                            <div className="absolute right-0 mt-2 w-48 bg-white rounded shadow-lg py-1">
                                ...
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 11c0-3.866 3.134-7 7-7s7 3.134 7 7-3.134 7-7 7-7-3.134-7-7z" />
                                    </svg>
                                    Change Password
                                </a>
                                <button
                                    onClick={handleLogout}
                                    className="w-full text-left text-xs text-red-600 hover:text-red-700 font-medium flex items-center gap-2 p-2 rounded hover:bg-red-50"
                                >
                    ...
                    {isSuperAdmin && (
                        <li>
                            <Link href="/superadmin/admins" className={`flex items-center p-3 rounded-lg ${url.startsWith('/superadmin') ? 'bg-gray-900 text-white' : 'hover:bg-gray-300'}`}>
                    ...
                    <li>
                        <Link href={route('resident')} className={`flex items-center p-3 rounded-lg ${url.startsWith('/residents-and-households') ? 'bg-gray-900 text-white' : 'hover:bg-gray-300'}`}>
                            <svg className="shrink-0 w-5 h-5 text-gray-500" fill="currentColor" viewBox="0 0 18 20">
                                <path d="M17 5.923A1 1 0 0 0 16 5h-3V4a4 4 0 1 0-8 0v1H2a1 1 0 0 0-1 .923L.086 17.846A2 2 0 0 0 2.08 20h13.84a2 2 0 0 0 1.994-2.153L17 5.923ZM7 9a1 1 0 0 1-2 0V7h2v2Zm0-5a2 2 0 1 1 4 0v1H7V4Zm6 5a1 1 0 1 1-2 0V7h2v2Z" />
                            </svg>
